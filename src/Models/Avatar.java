...
public class Avatar extends Player {
    ...
    // Especificamos las teclas de Movimiento. SON WASD.
    // Definimos un nivel de abstraccion para cada instancia de jugador para que cada uno
    // pueda tener distintas teclas.
    @Override
