...
public abstract class Stage implements  Runnable,KeyListener,
    ...
    protected volatile boolean _movementsRun = true;
...
public abstract class Stage implements Runnable, KeyListener,
    ...
    protected Thread _animator;
    protected Thread _movements;
    public volatile static boolean interactionEnable = true;
...
// end of capture components EVENTS ---------------
    ...
    public void initFSEM(){}                    // No implemented.
    public void initAFS(){}
    public void initUFS(){}
...
<<<<<<< HEAD
    ...
    @Override
    public void run(){
        if(bs==null) throw  new NullPointerException("Bufffer Strategy is Null");
...
<<<<<<< HEAD
    ...
    public void setSize(int w, int h) {
            _component.setPreferredSize(new Dimension(
                    w, h));
            if (_mode==SCREENMODE.JFRAME) _window.pack();
            else updateSize();
    ...
    public boolean setDisplayMode(DisplayMode dm) {
            if(_mode!=SCREENMODE.FSEM) return false;
